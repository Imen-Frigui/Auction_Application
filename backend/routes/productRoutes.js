...
router.route('/:id').put(protect, updateProductUser).post(protect, endBiding).get(getProductById).delete(protect, admin , deleteProduct).put(protect, admin, updateProduct)
